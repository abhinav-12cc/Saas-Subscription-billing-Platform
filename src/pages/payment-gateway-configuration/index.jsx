...
const PaymentGatewayConfiguration = () => {
  ...
  const validateConnections = async () => {
    ...
    const enabledGateways = Object.entries(configuration).filter(
  ...
  // Example: Replace payment gateway mock data
  const gateways = [
    {
      id: "gw-11",
      name: "PayNova",
      status: "active",
      apiKey: "pk_live_abcde",
      lastUsed: "2024-06-12",
    },
    {
      id: "gw-12",
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-text-secondary">
                  Manage multi-provider payment processing with secure API
                  integration
                </p>
              </div>
