...
const QuickActions = () => {
  ...
  const getPriorityColor = (priority) => {
    switch (priority) {
      case "high":
        return "bg-error-100 text-error-700 border-error-200 dark:bg-error-600 dark:text-white dark:border-error-600";
      case "medium":
        return "bg-warning-100 text-warning-700 border-warning-200 dark:bg-warning-600 dark:text-white dark:border-warning-600";
      case "low":
        return "bg-success-100 text-success-700 border-success-200 dark:bg-success-600 dark:text-white dark:border-success-600";
      default:
        return "bg-secondary-100 text-secondary-700 border-secondary-200 dark:bg-secondary-600 dark:text-white dark:border-secondary-600";
    }
  };
        ...
        <div className="space-y-3">
          {quickActions.map((action, index) => (
            <button
              ...
              className={`w-full ${action.color} ${action.hoverColor} text-white rounded-lg p-4 transition-all duration-200 transform hover:scale-105 hover:shadow-medium`}
            >
