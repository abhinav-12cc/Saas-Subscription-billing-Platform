  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-text-secondary">Sign in to your Sublytic account</p>
      </div>
      ...
      <div className="mt-6 p-4 bg-accent-50 border border-accent-200 rounded-lg">
        <h4 className="text-sm font-medium text-accent-800 mb-2">
          Demo Credentials:
        </h4>
        <div className="text-xs text-accent-700 space-y-1">
          <p>
            <strong>Admin:</strong> admin@sublyticdemo.com / Admin@456
          </p>
          <p>
            <strong>Finance:</strong> finance@sublyticdemo.com / Finance@456
          </p>
          <p>
            <strong>Customer:</strong> customer@company.com / Customer@123
          </p>
        </div>
      </div>
    </form>
