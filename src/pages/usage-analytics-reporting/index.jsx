        ...
        <div className="p-6">
          ...
          <div className="bg-surface rounded-lg shadow-card border border-border-light p-8 text-center">
            ...
            <p className="text-text-secondary mb-6">
              Explore real-time platform activity, growth trends, and user
              engagement statistics here.
            </p>
            <div className="text-sm text-text-tertiary">
              This section will soon include:
              <ul className="mt-2 space-y-1 text-left max-w-md mx-auto">
                <li>• Live user activity monitoring</li>
                <li>• Subscription churn and retention graphs</li>
                <li>• Revenue breakdown by product</li>
                <li>• Customizable exportable reports</li>
                <li>• API usage and error tracking</li>
              </ul>
            </div>
          </div>
        </div>
