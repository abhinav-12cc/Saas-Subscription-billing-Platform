          ...
          {filters.searchQuery && (
            ...
            >
              <Icon
                name="X"
                size={18}
                className="text-secondary-400 hover:text-text-primary transition-colors duration-200"
              />
            </button>
          )}
        </div>
                  ...
                  className={`
                    ...
                    ${
                      filters.status.includes(option.value)
                        ...
                        : "bg-secondary-50 text-text-secondary hover:bg-secondary-100 hover:text-text-primary"
                    }
                  `}
                >
                  <div
            ...
            <div className="flex flex-wrap gap-2">
              {billingFrequencyOptions.map((option) => (
                <button
                  key={option.value}
                  onClick={() =>
                    handleFilterChange("billingFrequency", option.value)
                  }
                  className={`
                    inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium transition-colors duration-200
                    ${
